...
class LastMatchAdapter (private val context: Context, private val lastMatch : MutableList<MatchItemModel>, private val mListener: LastmatchFragment.OnListFragmentInteractionListener?) :
        RecyclerView.Adapter<LastMatchAdapter.MatchViewHolder>(){
